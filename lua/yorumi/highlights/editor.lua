...
function M.setup(colors, config)
  ...
  return {
    ...
    CurSearch = { fg = theme.ui.fg, bg = theme.ui.bg_dim, bold = true },
    -- Cursor		Character under the cursor.
    Cursor = { fg = theme.ui.fg, bg = theme.ui.fg_dim },
    ...
    MsgSeparator = { bg = vim.o.cmdheight == 0 and theme.ui.bg or theme.ui.bg_p2 },
    -- MoreMsg		|more-prompt|
    MoreMsg = { fg = theme.diag.info },
    -- NonText		'@' at the end of the window, characters from 'showbreak' and other characters that do not really exist in the text (e.g., ">" displayed when a double-wide character doesn't fit at the end of the line). See also |hl-EndOfBuffer|.
    NonText = { fg = theme.ui.nontext },
    -- Normal		Normal text.
    Normal = { fg = theme.ui.fg, bg = theme.ui.fg },
    ...
    StatusLine = { fg = theme.ui.fg_dim, bg = theme.ui.bg_p2 },
    -- StatusLineNC	Status lines of not-current windows. Note: If this is equal to "StatusLine", Vim will use "^^^" in the status line of the current window.
    StatusLineNC = { fg = theme.ui.nontext, bg = theme.ui.bg_p2 },
    -- TabLine		Tab pages line, not active tab page label.
    TabLine = { bg = theme.ui.bg_p2, fg = theme.ui.special },
