...
function M.setup(colors, config)
  ...
  return {
    ...
    MiniStatuslineModeNormal = { fg = theme.ui.bg_p2, bg = theme.syn.fun, bold = true },
    ...
    MiniTablineHidden = { fg = theme.ui.special, bg = theme.ui.bg_p2 },
    MiniTablineModifiedCurrent = { fg = theme.ui.bg_p1, bg = theme.ui.fg_dim, bold = true },
    MiniTablineModifiedHidden = { fg = theme.ui.bg_p2, bg = theme.ui.special },
    MiniTablineModifiedVisible = { fg = theme.ui.bg_p2, bg = theme.ui.special, bold = true },
    MiniTablineTabpagesection = { fg = theme.ui.fg, bg = theme.ui.bg_search, bold = true },
    MiniTablineVisible = { fg = theme.ui.special, bg = theme.ui.bg_p2, bold = true },
